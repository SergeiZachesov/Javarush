...
Поскольку этот метод может быть переопределен в классах-наследниках, то компилятор не привязывает вызов этого метода к initialize() класса А, а отдает этот вопрос на решение джава-машины.
